...
<h1 class="text-3xl font-bold text-gray-800 mb-8 border-b pb-2">Semua Koleksi Kami</h1>

<?php if (empty($products)): ?>
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-md" role="alert">
        <p class="font-bold">Oops!</p>
        <p>Tampaknya belum ada produk yang terdaftar saat ini.</p>
    </div>
<?php else: ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transform hover:shadow-xl hover:-translate-y-1 transition duration-300 group">
            ...
            <div class="p-4 pt-0">
                <form action="cart.php" method="POST" class="flex justify-between items-center">
